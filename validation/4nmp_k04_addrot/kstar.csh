...
set curdir=`pwd`
set tempdir='/home/home3/sw283/github/osprey_refactor/validation/4nmp_k04_addrot/temp'
rm -r $tempdir/*
mkdir -p $tempdir
...
java -cp ${javaDir}:$jars -Xms4g -Xmx150g -Xss256m edu.duke.cs.osprey.control.Main -c KStar.cfg calcKStar System.cfg DEE.cfg > $tempdir/log.out
